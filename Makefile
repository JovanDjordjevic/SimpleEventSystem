...
do_cmake_linux:
	...
	cmake -G $(GENERATOR_LINUX) \
		  ...
		  -DSES_ENABLE_DOXYGEN=$(ENABLE_DOXYGEN_LINUX) \
		  -DSES_ENABLE_BUILD_TESTS=$(ENABLE_BUILD_TESTS_LINUX) \
		  -DSES_ENABLE_COVERAGE_REPORT=$(ENABLE_COVERAGE_REPORT_LINUX) \
		  -DSES_ENABLE_BUILD_EXAMPLES=$(ENABLE_BUILD_EXAMPLES_LINUX) \
		  -DSES_ENABLE_CALLGRIND_TARGETS=$(ENABLE_CALLGRIND_LINUX) \
		  -DSES_ENABLE_STATIC_ANALYSIS=$(ENABLE_STATIC_ANALYSIS_LINUX) \
		  -DSES_ENABLE_BRUTAL_COMPILE_OPTIONS=$(ENABLE_BRUTAL_COMPILE_OPTIONS_LINUX) \
		  -DSES_ENABLE_SANITIZERS=$(ENABLE_SANITIZERS_LINUX) \
		  .. && \
	cmake --build . && \
...
do_cmake_windows_vs:
	...
	cmake -G $(GENERATOR_WINDOWS) \
		  -DSES_ENABLE_DOXYGEN=$(ENABLE_DOXYGEN_WINDOWS) \
		  -DSES_ENABLE_BUILD_TESTS=$(ENABLE_BUILD_TESTS_WINDOWS) \
		  -DSES_ENABLE_COVERAGE_REPORT=$(ENABLE_COVERAGE_REPORT_WINDOWS) \
		  -DSES_ENABLE_BUILD_EXAMPLES=$(ENABLE_BUILD_EXAMPLES_WINDOWS) \
		  -DSES_ENABLE_CALLGRIND_TARGETS=$(ENABLE_CALLGRIND_WINDOWS) \
		  -DSES_ENABLE_STATIC_ANALYSIS=$(ENABLE_STATIC_ANALYSIS_WINDOWS) \
		  -DSES_ENABLE_BRUTAL_COMPILE_OPTIONS=$(ENABLE_BRUTAL_COMPILE_OPTIONS_WINDOWS) \
		  -DSES_ENABLE_SANITIZERS=$(ENABLE_SANITIZERS_WINDOWS) \
		  .. && \
